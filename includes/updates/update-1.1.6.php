...
function erp_update_table_1_1_6() {
    ...
    $table_name = $wpdb->get_blog_prefix() . 'erp_ac_transaction_items';
    ...
    $table_name   = $wpdb->get_blog_prefix() . 'erp_hr_announcement';
    ...
    $table_name = $wpdb->get_blog_prefix() . 'erp_audit_log';
    $columns    = $wpdb->get_col( "DESC $table_name" );
